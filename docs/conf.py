# -*- coding: utf-8 -*-
#
# pagerduty-api documentation build configuration file
...
htmlhelp_basename = 'pagerduty-apidoc'
...
latex_documents = [
  ('index', 'pagerduty-api.tex', u'pagerduty-api Documentation',
